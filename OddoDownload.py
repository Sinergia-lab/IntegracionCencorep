...
class OdooDownloadCenco(OdooDownloadBase):
    ...
    def comunicacion_masiva(self,anho,unidad_negocio,filename=None):
        ...
        borrar_truefalse = ['EAN','Trazabilidad levantamiento','Codigo regional','Equipo','PM asociado','PM asociado/Correo electrónico']
    ...
    def declaracion_eye(self,periodo,unidad_negocio,filename=None,download=True):
        ...
        if unidad_negocio == 'TXD':
            filtros = ['&','&','&','&',('x_studio_activo_producto','=',True),('x_studio_unidades_de_negocio','=',unidad_negocio),('x_studio_periodo.x_name','=',periodo),
                       ...
                       ('x_studio_total_paris','!=',0)]
        elif unidad_negocio == 'JUMBO':
            filtros = ['&','&','&',('x_studio_activo_producto','=',True),('x_studio_unidades_de_negocio','=',unidad_negocio),('x_studio_periodo.x_name','=',periodo),
                       '|',('x_studio_total_conveniencia','!=',0),('x_studio_total_jumbo','!=',0)]
        else:
            filtros = ['&','&','&',('x_studio_activo_producto','=',True),('x_studio_unidades_de_negocio','=',unidad_negocio),('x_studio_periodo.x_name','=',periodo),
                       (campos_ventas_totales[0],'!=',0)]
    ...
    def config_declaracionesSig(self):
        filtros = []
        campos = ['x_active','x_studio_unidad_de_negocio','x_studio_periodo',
                    'x_studio_razon_social','x_studio_generar_detalle_elementos','x_studio_doc_generado']
        return self.getDataFromModel('x_declaracion_sig',filtros,campos,ret_=True)
...
class OdooDownloadCorona(OdooDownloadBase):
    ...
    def comunicacion_masiva(self,periodo,filename=None):
        ...
        borrar_truefalse = ['EAN','Trazabilidad levantamiento','PM asociado','PM asociado/Correo electrónico']
...
class OdooDownloadTottus(OdooDownloadBase):
    ...
    def comunicacion_masiva(self,periodo,filename=None):
        ...
        borrar_truefalse = ['Actor relevante','Actor relevante/Correo electrónico','Trazabilidad levantamiento']
